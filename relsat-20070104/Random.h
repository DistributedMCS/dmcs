...
public:
   ...
   unsigned int iRandom(unsigned int iMax_) {return ((unsigned int)0);}
   unsigned long lRandom(unsigned long lMax_) {return ((unsigned long)0);}
   boolean bRandom() {return (boolean)(0);}
