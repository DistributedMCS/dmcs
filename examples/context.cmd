./new_dmcsd --context=0 --port=5000 --system-size=0 --packsize=4 --belief-state-size=10 --kb=../../examples/context0.lp --br=../../examples/context0.br --queryplan=../../examples/context0.qp
