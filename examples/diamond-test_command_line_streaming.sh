...
sleep 20
/usr/bin/time --portability -o diamond-test-dmcs-streaming-time.log $DMCSPATH/dmcsc --hostname=localhost --port=5001 --streaming=1 --packsize=100 --system-size=4 > diamond-test-dmcs-streaming.log 2> diamond-test-dmcs-streaming-err.log
killall dmcsd
