...
#ifndef DYN_RAKE_TOPO_GENERATOR
#define DYN_RAKE_TOPO_GENERATOR

#include "generator/DynTopologyGenerator.h"

namespace dmcs { namespace generator {

class DynRakeTopoGenerator : public DynTopologyGenerator
{
public:
  DynRakeTopoGenerator(MatchVecPtr mt_, GraphPtr initial_topology_, 
