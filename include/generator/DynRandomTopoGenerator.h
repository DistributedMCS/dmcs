...
#ifndef DYN_RANDOM_TOPO_GENERATOR
#define DYN_RANDOM_TOPO_GENERATOR

#include "generator/DynTopologyGenerator.h"

namespace dmcs { namespace generator {

class DynRandomTopoGenerator : public DynTopologyGenerator
{
public:
  DynRandomTopoGenerator(MatchVecPtr mt_, GraphPtr initial_topology_, 
...
#endif // DYN_RANDOM_TOPO_GENERATOR
