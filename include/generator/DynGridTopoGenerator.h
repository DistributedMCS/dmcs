...
#ifndef DYN_GRID_TOPO_GENERATOR
#define DYN_GRID_TOPO_GENERATOR

#include "generator/DynTopologyGenerator.h"

namespace dmcs { namespace generator {

class DynGridTopoGenerator : public DynTopologyGenerator
{
public:
  DynGridTopoGenerator(MatchVecPtr mt_, GraphPtr initial_topology_, 
