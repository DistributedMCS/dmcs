...
#ifndef DYN_TOPOLOGY_GENERATOR
#define DYN_TOPOLOGY_GENERATOR
...
class DynTopologyGenerator
{
public:
  DynTopologyGenerator(MatchVecPtr mt_, GraphPtr initial_topology_, 
