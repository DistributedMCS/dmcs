...
#ifndef DIAMOND_QUERY_PLAN_GENERATOR_H_
#define DIAMOND_QUERY_PLAN_GENERATOR_H_
...
class DiamondQPGenerator : public QueryPlanGenerator
{
public:
  DiamondQPGenerator(ContextsPtr& contexts_, QueryPlanPtr& query_plan_)
