...
#ifndef NO_SBA_CTX_SORTING_STRATEGY_H
#define NO_SBA_CTX_SORTING_STRATEGY_H
...
class NoSBACtxSortingStrategy : public ContextSortingStrategy
{
public:
  // IteratorListPtr == shared_ptr of list of iterators of a MatchTableIteratorVec
  NoSBACtxSortingStrategy(IteratorListPtr list_to_sort_, CountVecPtr sba_count_,
...
#endif // NO_SBA_CTX_SORTING_STRATEGY_H
